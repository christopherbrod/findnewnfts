...
const data = [
  {
    ...
    author: author1,
    logo: logo1,
    text: `This tool enables me to analyse market more efficiently and be quicker than anyone else.`,
    authorName: 'Karolin Astaize',
    designation: 'NFT Collector',
  },
  {
    id: 2,
    author: author2,
    logo: logo2,
    text: `It shows me everything I need to make informed decisions.`,
    authorName: 'Paul Sigmunds',
    designation: 'NFT Investor',
  },
  {
    id: 3,
    author: author1,
    logo: logo1,
    text: `I love the simplicity - it has everything I need and more!`,
    authorName: 'Marc Henc',
